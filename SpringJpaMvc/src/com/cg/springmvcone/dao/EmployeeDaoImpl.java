...
public class EmployeeDaoImpl implements IEmployeeDao
{
	...
	public void updateEmployee(int empId) {
		// TODO Auto-generated method stub
		Query queryFour=entitymanager.createQuery("UPDATE Employee SET empName='Bujji',empSalary=25000 WHERE empId=:eid");
	...
	public Employee searchEmployee(int id) {
		...
		Employee emp=(Employee) queryThree.getResultList();
		return emp;
